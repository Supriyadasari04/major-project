...
//     // ✅ reload journals list after saving
//     const updatedJournals = await getJournalEntries();
...
const [editedContent, setEditedContent] = useState("");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // ✅ FIX: chatHistory is now async (session-based)
            ...
            <DialogContent className="max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 pt-4">
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Any obstacles or struggles..."
                    value={challenges}
                ...
                <div>
                  ...
                  <Textarea
                    placeholder="Insights or lessons..."
                    value={lessons}
            ...
            <Card variant="soft">
              <CardContent className="py-8 text-center">
                <p className="text-muted-foreground">
                  Your journal entries will appear here after reflections.
                </p>
              </CardContent>
            </Card>
          ) : (
...
<Dialog open={isJournalOpen} onOpenChange={setIsJournalOpen}>
  <DialogContent className="max-h-[90vh] overflow-y-auto">
    <DialogHeader>
      <DialogTitle>
        {activeJournal?.date
          ? new Date(activeJournal.date).toLocaleDateString("en-US", {
              weekday: "long",
              month: "long",
              day: "numeric",
            })
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => setIsEditingJournal((prev) => !prev)}
            >
        ...
        {isEditingJournal ? (
          <>
            ...
            <Button
              ...
              onClick={async () => {
                try {
                  const updated = await updateJournalEntry(activeJournal.id, {
